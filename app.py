...
st.markdown(
""" <div class="luxury-nav"> <div class="luxury-logo">Dr. Omnea Ali</div>
...
# =====================================================
# IMPORTANT:
# Plotly الحديثة لا تستخدم titlefont مباشرة.
# يجب استخدام title=dict(text=..., font=dict(...))
# =====================================================
...
if uploaded_file is not None:
    ...
    with col_img:
        ...
        try:
            ...
            st.error(
                "تعذر قراءة الصورة. "
                "يرجى رفع JPG أو JPEG أو PNG صالح."
            )
...
if st.button(
    ...
    try:
        ...
        if not isinstance(result, tuple) or len(result) != 3:
            ...
            st.error(
                "clinical_risk_assessment يجب أن يعيد "
                "ثلاث قيم: risk_score, risk_level, recommendations"
            )
        ...
        st.error(
            "حدث خطأ أثناء تشغيل Clinical Risk Engine."
        )
